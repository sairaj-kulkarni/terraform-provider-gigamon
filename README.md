...
Please copy the terraform binary "terraform-provider-fm" to the following directory in your
system

~/.terraform.d/plugins/local/gigamon/fm/1.0.0/linux_amd64/terraform-provider-fm
...
----------------------------------------
  - Please setup the environment variable GOBIN to the following
    ~/.terraform.d/plugins/local/gigamon/fm/1.0.0/linux_amd64/
